...
export default function BuyerFilterToShip() {
        ...
        const subscriber = firebase.firestore()
            ...
            .onSnapshot(querySnapshot => {
                ...
                querySnapshot.forEach(documentSnapshot => {
                    if (documentSnapshot.data().buyerId === firebase.auth().currentUser.uid && documentSnapshot.data().orderStatus === 'To Ship' || documentSnapshot.data().orderStatus === 'Waiting') {
                        data.push({
                            ...
                            >
                                ...
                                <View style={{
                                    ...
                                    <View style={{ flexDirection: 'row', alignItems: 'center' }} >
                                        ...
                                        <Ionicons name='cube' size={15} color={Colors.DEFAULT_YELLOW} />
                                        <Text style={{
                                            fontFamily: 'PoppinsSemiBold',
