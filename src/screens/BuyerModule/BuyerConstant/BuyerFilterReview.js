...
export default function BuyerFilterReview() {
        ...
        const subscriber = firebase.firestore()
            ...
            .onSnapshot(querySnapshot => {
                ...
                querySnapshot.forEach(documentSnapshot => {
                    if (documentSnapshot.data().buyerId === firebase.auth().currentUser.uid && documentSnapshot.data().orderStatus === 'Completed') {
                        data.push({
                        ...
                        renderItem={({ item }) => (
                            ...
                            >
                                ...
                                <View style={{
                                    ...
                                    {
                                        item.rated == 1 ? <View style={{ flexDirection: 'row', alignItems: 'center' }} >
                                            <AntDesign name='star' size={14} color={Colors.DEFAULT_YELLOW2} />
                                            <Text style={{
                                                fontFamily: 'PoppinsSemiBold',
