...
const defaultProfile = require('../../../assets/Icon/riderProfile.jpg');


export default function RiderEditProfile({ navigation }) {
    ...
    useEffect(() => {
        const subscriber = firebase.firestore()
            ...
            .onSnapshot(documentSnapshot => {
                setRiderData(documentSnapshot.data());
                    ...
                    <View>
                        {
                            ...
                            />
                                ...
                                <View>
                                    {
                                        riderData.profileUrl ? <Image
                                            source={{ uri: riderData.profileUrl }}
                                            resizeMode='contain'
                                            style={{
                                                width: 140,
                                                height: 140,
        ...
        return (
            <View
                style={{
                    alignItems: 'center',
                    justifyContent: 'center',
                    marginTop: Display.setHeight(23),
                }}
            >
                <TouchableOpacity
                    style={{
