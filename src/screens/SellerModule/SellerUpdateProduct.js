...
export default function SellerUpdateProduct({ navigation, route }) {
    ...
    useEffect(() => {
        const subscriber = firebase.firestore()
            ...
            .onSnapshot(documentSnapshot => {
                ...
                setProductCategory(documentSnapshot.data().productCategory);
                setProductName(documentSnapshot.data().productName);
                setProductDescription(documentSnapshot.data().productDescription);
                setProductPrice(documentSnapshot.data().productPrice);
                setProductStock(documentSnapshot.data().productStock);
                setItemWeight(documentSnapshot.data().itemWeight);
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        >
                            ...
                            > Your changes have been successfully saved.</Text>
                        </View>
                ...
                >
                    ...
                    <TouchableOpacity
                        style={{
                            borderRadius: 5,
                            borderWidth: 0.9,
                            borderColor: productCategory == 'Painting' ? Colors.DEFAULT_YELLOW2 : Colors.LIGHT_GREY2,
                            justifyContent: 'center',
                            alignItems: 'center',
                            width: 90,
                            height: 80,
                        ...
                        onPress={() => {
                            setProductCategory('Painting');
                            setCategoryError(null);
                        }}
                    >
                        {
                            productCategory == 'Painting' && <Ionicons name='checkmark-circle-sharp' size={18} color={Colors.DEFAULT_YELLOW}
                                style={{
                                    position: 'absolute',
                                    top: 0,
                                    right: 0,
