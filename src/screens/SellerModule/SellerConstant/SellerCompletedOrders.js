...
export default function SellerCompletedOrders() {
        ...
        const subscriber = firebase.firestore()
            ...
            .onSnapshot(querySnapshot => {
                ...
                querySnapshot.forEach(documentSnapshot => {
                    ...
                    if (documentSnapshot.data().sellerUid === userId && documentSnapshot.data().orderStatus === 'Completed') {
                        data.push({
                            ...
                            renderItem={({ item }) => (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <Feather name="check" size={14} color={Colors.DEFAULT_GREEN} />
                                            <Text
                                                style={{
                                                    fontFamily: 'PoppinsSemiBold',
                                                    fontSize: RFPercentage(1.8),
